...
// import { uniswapv2ActionProvider, Uniswapv2ActionProvider } from "@/uniswapActionProvider";
  ...
  try {
    ...
    const agentkit = await AgentKit.from({
      ...
      actionProviders: [
        ...
        erc20ActionProvider(),
        cdpApiActionProvider(),
        // uniswapv2ActionProvider(), // Temporarily disabled due to compilation errors
      ],
    });
